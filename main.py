...
def run_bot_wrapper(token):
    asyncio.run(run_bot(token))


if __name__ == '__main__':
    channels = [channel1, channel2]  # Replace with your desired channel IDs
  ...
  , "token1"
    ...
    for token in tokens:
        process = multiprocessing.Process(target=run_bot_wrapper, args=(token,))
